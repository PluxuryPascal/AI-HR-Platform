...
export function OverviewChart() {
    ...
    return (
        <Card className="col-span-1 md:col-span-2 border-white/10 bg-white/5 backdrop-blur-md shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] hover:shadow-lg transition-all duration-300 dark:bg-white/5 dark:border-white/10">
            <CardHeader>
